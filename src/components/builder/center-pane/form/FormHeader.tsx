...
const FormHeaderContent = () => {
  ...
  return (
    <div className="flex flex-col gap-1 px-2">
      <h3 className="font-bold text-xl" style={{ color: formTheme?.properties?.primaryTextColor }}>
        {formName}
      </h3>
      <p className="font-semibold text-[13px]" style={{ color: formTheme?.properties?.primaryTextColor }}>
        {formDescription}
      </p>
    </div>
  );
